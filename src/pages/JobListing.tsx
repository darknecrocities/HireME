              ...
              <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                ...
                <div className="md:col-span-3 flex items-center gap-4">
                  <button
                    ...
                    className={`flex-1 py-4 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] transition-all border shrink-0 ${
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-[2] py-4 rounded-2xl bg-white text-black font-black text-[10px] uppercase tracking-[0.2em] hover:scale-[1.02] transition-all flex items-center justify-center gap-2 shadow-[0_10px_30px_rgba(255,255,255,0.1)] active:scale-95 disabled:opacity-50"
                  >
